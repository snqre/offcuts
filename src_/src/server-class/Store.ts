import type { Database } from "src_/src/server-class/_";
import type { DatabaseE } from "src_/src/server-class/_";
import type { ProductR } from "src_/src/server-class/_";
import type { ProductE } from "src_/src/server-class/_";
...
import { Product } from "src_/src/server-class/_";
